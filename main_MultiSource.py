...
for i in range(1,7):
    ...
    val_acc,test_acc = exp(shot=i,shuffle=False,epoch=600)
...
plt.title('Two simulators: TOSSIM, NS-3', fontsize=14)

# plt.title('Validation and Test Accuracy Over Different Shots of Data (Two Simulators)', fontsize=16)
